...
function Download() {
  const socketUrl = "wss://api.trending-trawler.com//video";
  ...
  return (
    <div className="relative">
      <div
        className="absolute top-1/2 left-0 w-48 h-48 rounded-tl-full rounded-bl-full bg-purple-400 bg-opacity-60
        blur-own2 z-0"
      ></div>
      <div className="container pb-10 mx-auto">
        <div className="pt-10 text-white text-sm flex flex-col gap-4 justify-center font-bold text-xl">
          <div className="m-auto text-center">
            <button
              id="downloadBtn"
              className="generator w-50 text-lg text-center"
