      ...
      <div className="pt-10 text-white text-sm flex flex-col gap-4 justify-center font-bold text-xl">
        ...
        <div className="m-auto text-center">
          <button id="downloadBtn" className="generator w-50 text-lg text-center" onClick={handleDownload}>
            Generate
            <svg className="feather feather-play inline ml-1 pb-1" fill="white" height="20" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
